...
//     this->setPalette(palt);
    ...
    openAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/open.png"));//图标
    ...
    saveAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/save.png"));//图标
    ...
    saveasAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/saveas.png"));//图标
    ...
    lineAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/line1.png"));//图标
    ...
    linesAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/lines.png"));//图标
    ...
    rectAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/rect.png"));//图标
    ...
    ellipseAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/ellipse.png"));//图标
    ...
    textAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/texts.png"));//图标
    textAction->setShortcut(QKeySequence(tr("Ctrl+T")));//热键
    tbar->addAction(textAction);

    QAction *layerAction = new QAction(tr("&图层"), this);//图层动作
    layerAction->setIcon(QIcon("C:/Users/RAY/Desktop/qt/GRAPHEDITORTEST/GRAPHEDITORTEST/project/png/images/layer.png"));//图标
    layerAction->setShortcut(QKeySequence(tr("Ctrl+L")));//热键
    tbar->addAction(layerAction);
    ...
    connect(layerAction, SIGNAL(triggered()), this, SLOT(Layer()));
    //connect(textAction, SIGNAL(triggered()), this, SLOT(Texts()));
...
void MyPaint::mousePressEvent(QMouseEvent *e)
{
    if(e->button() == Qt::LeftButton)//当鼠标左键按下
    {
        ...
        else if (_drawType == 6)//图层管理
         {

            QMessageBox MSGBOX;
                 MSGBOX.setText("您图层管理了吗");
                 MSGBOX.exec();
    ...
    if (e->button() == Qt::RightButton )//&& e->type() == QEvent::MouseButtonDblClick)
    {
        QMessageBox MSGBOX;
             MSGBOX.setText("您右击了");
             MSGBOX.exec();
